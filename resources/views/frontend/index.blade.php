                ...
                <div class="rev_slider fullwidthabanner" id="rev_slider_two" data-version="5.4.1">
                    <ul>
                        ...
                        <li data-description="Slide Description" data-easein="default" data-easeout="default"
                            ...
                            data-thumb="images/main-slider/image-4.jpg" data-title="Slide Title"
                            ...
                            <div class="tp-caption " data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                ...
                                data-type="text" data-height="none" data-width="['520','520','400','290']"
                            ...
                            <div class="tp-caption " data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                data-paddingright="[0,0,0,0]" data-paddingtop="[0,0,0,0]" data-responsive_offset="on"
                                data-type="text" data-height="none" data-width="['1000','800','400','290']"
                                data-whitespace="normal" data-hoffset="['15','15','15','15']"
                            ...
                            <div class="tp-caption" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                ...
                                data-width="['600','600','400','290']" data-hoffset="['15','15','15','15']"
                                data-voffset="['30','20','0','-15']" data-x="['middle','middle','middle','middle']"
                                data-y="['middle','middle','middle','middle']"
                                data-textalign="['top','top','top','top']"
                            ...
                            <div class="tp-caption tp-resizeme" data-paddingbottom="[0,0,0,0]"
                                ...
                                data-height="none" data-width="['600','600','400','290']" data-whitespace="normal"
                                data-hoffset="['15','15','15','15']" data-voffset="['130','110','100','100']"
                                data-x="['middle','middle','middle','middle']"
                                data-y="['middle','middle','middle','middle']"
                                data-textalign="['top','top','top','top']"
                ...
                <div class="single-item-carousel owl-carousel owl-theme owl-nav-none owl-dot-style-three">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="author-info">
                                    <div class="image"><img src="{{ asset('assets/images/resource/author-1.jpg') }}"
                                            alt=""></div>
                                    <h4>Teena Venanda</h4>
                            ...
                            <div class="col-md-9">
                                <div class="content">
                                    ...
                                    <div class="text">Must explain to you how mistaken our idea denouncing pleasure &
                                        praising pain was born & we will give expound human happiness know to pursue
                                        pleasure...</div>
                                </div>
                    ...
                    <div class="testimonial-block-one">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="author-info">
                                    <div class="image"><img src="{{ asset('assets/images/resource/author-2.jpg') }}"
                                            alt=""></div>
                                    <h4>Adam Smith</h4>
                        ...
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                ...
                                <div class="overlay">
                                    <div class="designation"><a href="#">CEO / Founder</a></div>
                                    <h4>Mark Fletcher</h4>
                                    <div class="text">Expound the actual of the great explorer of the truth, the
                                        master human.</div>
                                    <ul class="social-link">
                                        <li><a href="#">Facebook</a></li>
                                        <li><a href="#">Twitter</a></li>
        ...
        <section class="map-section" id="contact">
            ...
            <div class="container">
                <div class="default-form-area ">
                    ...
                    <form id="contact-form" name="contact_form" class="contact-form style-four"
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group style-two">
                                    <input type="email" name="form_subject" class="form-control required email"
